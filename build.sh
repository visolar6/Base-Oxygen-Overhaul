...
PLUGIN_DIR="$SUBNAUTICA_PATH/BepInEx/plugins/BaseOxygenOverhaul"
DLL_PATH="BaseOxygenOverhaul/bin/Release/net472/BaseOxygenOverhaul.dll"
LOCALIZATION_PATH="BaseOxygenOverhaul/Localizations.xml"
ASSETS_PATH="BaseOxygenOverhaul/Assets"
if [ -f "$DLL_PATH" ]; then
    mkdir -p "$PLUGIN_DIR"
