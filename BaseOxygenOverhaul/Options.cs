...
namespace BaseOxygenOverhaul
{
    ...
    {
        [Slider(LabelLanguageId = "ProductionRateSmallOxygenGenerator", TooltipLanguageId = "Tooltip_ProductionRateSmallOxygenGenerator", DefaultValue = 1f, Min = 0.1f, Max = 2.5f, Step = 0.01f, Format = "{0:0.0}")]
        public float ProductionRateSmallOxygenGenerator = 1f;
